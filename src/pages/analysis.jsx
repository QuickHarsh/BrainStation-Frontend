...
import { getCompletedTasksCount, getStudentAlerts,getCompletedTasks } from "@/service/task";
              ...
              <div className="lg:w-1/2 w-full flex flex-col gap-6">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <div className="flex flex-col gap-4 flex-1">
                          ...
                          <div className="p-4 bg-white border border-gray-200 rounded-lg flex flex-col items-center gap-4" style={{ minWidth: "300px" }}>
                          ...
                          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-lg flex flex-col justify-center items-center" style={{ minWidth: "300px" }}>
